...
class Person:
    def __init__(self, globalParameters=None, tag=None, id=None):
        ...
        self.ageGroupsList = ["[all]", "[0-9]", "[10-19]", "[20-29]", "[30-39]", "[40-49]", "[50-59]", "[60-69]", "[70-79]",
                              "[80-89]", "[90-99]", "[ALL]"]
    ...
    def select_relatives(self, listOfPeople, amount):
        self.listOfRelatives = random.choices(listOfPeople, k=amount)
